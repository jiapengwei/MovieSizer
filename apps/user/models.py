...
# class RecBaseUserInfo(models.Model):
#     AGE_RANGE = (
#         MaxValueValidator(150),
#         MinValueValidator(1)
#     )
...
class EmailVerifyRecord(models.Model):
    ...
    send_time = models.DateTimeField(
        default=datetime.now, verbose_name="发送时间")  # datatime.now 需要将括号去掉, 如果不去掉的话会使用编译到这里时的时间, 只有将括号去掉的时候才会使用实例化时的时间
